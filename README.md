...
silver/      Cleaned and merged listings
gold/        Final modelling dataset and model results
scripts/     Data pipeline and modelling scripts
dashboard/   Price transparency tool
...
Tool can be accessed, through this link:  https://ditlevhersted-git.github.io/aarhus-rental-tool/
